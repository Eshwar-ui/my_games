...
class _OfflineSettingsScreenState extends State<OfflineSettingsScreen> {
  ...
  Future<void> _resetLocalData() async {
        ...
        await showDialog<bool>(
          ...
          builder: (context) {
            return AlertDialog(
              ...
              content: const Text(
                'This clears saved highscores, local stats, and settings on this device only.',
    ...
    await ArcadeStatsService.clearAll();
                ...
                children: [
                  ...
                  _SettingsPanel(
                    ...
                    child: Column(
                      ...
                      children: [
                        const Text(
                          'Reset local data to clear highscores, dashboard stats, and saved preferences from this device.',
                          style: TextStyle(color: Colors.white70, height: 1.5),
                        ),
